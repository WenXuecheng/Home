...
}`;function qE(n,e,t){let i=new af;const r=new et,s=new et,o=new vt,a=new GE({depthPacking:bv}),l=new WE,c={},u=t.maxTextureSize,f={[rr]:sn,[sn]:rr,[Mi]:Mi},h=new Ri({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new et},radius:{value:4}},vertexShader:XE,fragmentShader:YE}),p=h.clone();p.defines.HORIZONTAL_PASS=1;const g=new ar;g.setAttribute("position",new Tn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new ni(g,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Fp;let d=this.type;this.render=function(R,w,L){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||R.length===0)return;const M=n.getRenderTarget(),S=n.getActiveCubeFace(),U=n.getActiveMipmapLevel(),V=n.state;V.setBlending(Ji),V.buffers.color.setClear(1,1,1,1),V.buffers.depth.setTest(!0),V.setScissorTest(!1);const F=d!==mi&&this.type===mi,J=d===mi&&this.type!==mi;for(let te=0,z=R.length;te<z;te++){const G=R[te],O=G.shadow;if(O===void 0){console.warn("THREE.WebGLShadowMap:",G,"has no shadow.");continue}if(O.autoUpdate===!1&&O.needsUpdate===!1)continue;r.copy(O.mapSize);const ue=O.getFrameExtents();if(r.multiply(ue),s.copy(O.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/ue.x),r.x=s.x*ue.x,O.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/ue.y),r.y=s.y*ue.y,O.mapSize.y=s.y)),O.map===null||F===!0||J===!0){const he=this.type!==mi?{minFilter:qn,magFilter:qn}:{};O.map!==null&&O.map.dispose(),O.map=new zr(r.x,r.y,he),O.map.texture.name=G.name+".shadowMap",O.camera.updateProjectionMatrix()}n.setRenderTarget(O.map),n.clear();const fe=O.getViewportCount();for(let he=0;he<fe;he++){const Te=O.getViewport(he);o.set(s.x*Te.x,s.y*Te.y,s.x*Te.z,s.y*Te.w),V.viewport(o),O.updateMatrices(G,he),i=O.getFrustum(),v(w,L,O.camera,G,this.type)}O.isPointLightShadow!==!0&&this.type===mi&&E(O,L),O.needsUpdate=!1}d=this.type,m.needsUpdate=!1,n.setRenderTarget(M,S,U)};function E(R,w){const L=e.update(_);h.defines.VSM_SAMPLES!==R.blurSamples&&(h.defines.VSM_SAMPLES=R.blurSamples,p.defines.VSM_SAMPLES=R.blurSamples,h.needsUpdate=!0,p.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new zr(r.x,r.y)),h.uniforms.shadow_pass.value=R.map.texture,h.uniforms.resolution.value=R.mapSize,h.uniforms.radius.value=R.radius,n.setRenderTarget(R.mapPass),n.clear(),n.renderBufferDirect(w,null,L,h,_,null),p.uniforms.shadow_pass.value=R.mapPass.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,n.setRenderTarget(R.map),n.clear(),n.renderBufferDirect(w,null,L,p,_,null)}function T(R,w,L,M){let S=null;const U=L.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(U!==void 0)S=U;else if(S=L.isPointLight===!0?l:a,n.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const V=S.uuid,F=w.uuid;let J=c[V];J===void 0&&(J={},c[V]=J);let te=J[F];te===void 0&&(te=S.clone(),J[F]=te,w.addEventListener("dispose",C)),S=te}if(S.visible=w.visible,S.wireframe=w.wireframe,M===mi?S.side=w.shadowSide!==null?w.shadowSide:w.side:S.side=w.shadowSide!==null?w.shadowSide:f[w.side],S.alphaMap=w.alphaMap,S.alphaTest=w.alphaTest,S.map=w.map,S.clipShadows=w.clipShadows,S.clippingPlanes=w.clippingPlanes,S.clipIntersection=w.clipIntersection,S.displacementMap=w.displacementMap,S.displacementScale=w.displacementScale,S.displacementBias=w.displacementBias,S.wireframeLinewidth=w.wireframeLinewidth,S.linewidth=w.linewidth,L.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const V=n.properties.get(S);V.light=L}return S}function v(R,w,L,M,S){if(R.visible===!1)return;if(R.layers.test(w.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&S===mi)&&(!R.frustumCulled||i.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,R.matrixWorld);const F=e.update(R),J=R.material;if(Array.isArray(J)){const te=F.groups;for(let z=0,G=te.length;z<G;z++){const O=te[z],ue=J[O.materialIndex];if(ue&&ue.visible){const fe=T(R,ue,M,S);R.onBeforeShadow(n,R,w,L,F,fe,O),n.renderBufferDirect(L,null,F,fe,R,O),R.onAfterShadow(n,R,w,L,F,fe,O)}}}else if(J.visible){const te=T(R,J,M,S);R.onBeforeShadow(n,R,w,L,F,te,null),n.renderBufferDirect(L,null,F,te,R,null),R.onAfterShadow(n,R,w,L,F,te,null)}}const V=R.children;for(let F=0,J=V.length;F<J;F++)v(V[F],w,L,M,S)}function C(R){R.target.removeEventListener("dispose",C);for(const L in c){const M=c[L],S=R.target.uuid;S in M&&(M[S].dispose(),delete M[S])}}}const $E={[Cc]:Pc,[Dc]:Uc,[Lc]:Nc,[ws]:Ic,[Pc]:Cc,[Uc]:Dc,[Nc]:Lc,[Ic]:ws};function KE(n,e){function t(){let B=!1;const xe=new vt;let ie=null;const oe=new vt(0,0,0,0);return{setMask:function(ye){ie!==ye&&!B&&(n.colorMask(ye,ye,ye,ye),ie=ye)},setLocked:function(ye){B=ye},setClear:function(ye,Se,He,ft,wt){wt===!0&&(ye*=ft,Se*=ft,He*=ft),xe.set(ye,Se,He,ft),oe.equals(xe)===!1&&(n.clearColor(ye,Se,He,ft),oe.copy(xe))},reset:function(){B=!1,ie=null,oe.set(-1,0,0,0)}}}function i(){let B=!1,xe=!1,ie=null,oe=null,ye=null;return{setReversed:function(Se){if(xe!==Se){const He=e.get("EXT_clip_control");xe?He.clipControlEXT(He.LOWER_LEFT_EXT,He.ZERO_TO_ONE_EXT):He.clipControlEXT(He.LOWER_LEFT_EXT,He.NEGATIVE_ONE_TO_ONE_EXT);const ft=ye;ye=null,this.setClear(ft)}xe=Se},getReversed:function(){return xe},setTest:function(Se){Se?pe(n.DEPTH_TEST):Ae(n.DEPTH_TEST)},setMask:function(Se){ie!==Se&&!B&&(n.depthMask(Se),ie=Se)},setFunc:function(Se){if(xe&&(Se=$E[Se]),oe!==Se){switch(Se){case Cc:n.depthFunc(n.NEVER);break;case Pc:n.depthFunc(n.ALWAYS);break;case Dc:n.depthFunc(n.LESS);break;case ws:n.depthFunc(n.LEQUAL);break;case Lc:n.depthFunc(n.EQUAL);break;case Ic:n.depthFunc(n.GEQUAL);break;case Uc:n.depthFunc(n.GREATER);break;case Nc:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}oe=Se}},setLocked:function(Se){B=Se},setClear:function(Se){ye!==Se&&(xe&&(Se=1-Se),n.clearDepth(Se),ye=Se)},reset:function(){B=!1,ie=null,oe=null,ye=null,xe=!1}}}function r(){let B=!1,xe=null,ie=null,oe=null,ye=null,Se=null,He=null,ft=null,wt=null;return{setTest:function(be){B||(be?pe(n.STENCIL_TEST):Ae(n.STENCIL_TEST))},setMask:function(be){xe!==be&&!B&&(n.stencilMask(be),xe=be)},setFunc:function(be,we,$e){(ie!==be||oe!==we||ye!==$e)&&(n.stencilFunc(be,we,$e),ie=be,oe=we,ye=$e)},setOp:function(be,we,$e){(Se!==be||He!==we||ft!==$e)&&(n.stencilOp(be,we,$e),Se=be,He=we,ft=$e)},setLocked:function(be){B=be},setClear:function(be){wt!==be&&(n.clearStencil(be),wt=be)},reset:function(){B=!1,xe=null,ie=null,oe=null,ye=null,Se=null,He=null,ft=null,wt=null}}}const s=new t,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let u={},f={},h=new WeakMap,p=[],g=null,_=!1,m=null,d=null,E=null,T=null,v=null,C=null,R=null,w=new Ke(0,0,0),L=0,M=!1,S=null,U=null,V=null,F=null,J=null;const te=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let z=!1,G=0;const O=n.getParameter(n.VERSION);O.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(O)[1]),z=G>=1):O.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(O)[1]),z=G>=2);let ue=null,fe={};const he=n.getParameter(n.SCISSOR_BOX),Te=n.getParameter(n.VIEWPORT),ze=new vt().fromArray(he),ee=new vt().fromArray(Te);function ae(B,xe,ie,oe){const ye=new Uint8Array(4),Se=n.createTexture();n.bindTexture(B,Se),n.texParameteri(B,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(B,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let He=0;He<ie;He++)B===n.TEXTURE_3D||B===n.TEXTURE_2D_ARRAY?n.texImage3D(xe,0,n.RGBA,1,1,oe,0,n.RGBA,n.UNSIGNED_BYTE,ye):n.texImage2D(xe+He,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,ye);return Se}const ve={};ve[n.TEXTURE_2D]=ae(n.TEXTURE_2D,n.TEXTURE_2D,1),ve[n.TEXTURE_CUBE_MAP]=ae(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),ve[n.TEXTURE_2D_ARRAY]=ae(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),ve[n.TEXTURE_3D]=ae(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),pe(n.DEPTH_TEST),o.setFunc(ws),X(!1),D(ch),pe(n.CULL_FACE),b(Ji);function pe(B){u[B]!==!0&&(n.enable(B),u[B]=!0)}function Ae(B){u[B]!==!1&&(n.disable(B),u[B]=!1)}function Ie(B,xe){return f[B]!==xe?(n.bindFramebuffer(B,xe),f[B]=xe,B===n.DRAW_FRAMEBUFFER&&(f[n.FRAMEBUFFER]=xe),B===n.FRAMEBUFFER&&(f[n.DRAW_FRAMEBUFFER]=xe),!0):!1}function Ne(B,xe){let ie=p,oe=!1;if(B){ie=h.get(xe),ie===void 0&&(ie=[],h.set(xe,ie));const ye=B.textures;if(ie.length!==ye.length||ie[0]!==n.COLOR_ATTACHMENT0){for(let Se=0,He=ye.length;Se<He;Se++)ie[Se]=n.COLOR_ATTACHMENT0+Se;ie.length=ye.length,oe=!0}}else ie[0]!==n.BACK&&(ie[0]=n.BACK,oe=!0);oe&&n.drawBuffers(ie)}function qe(B){return g!==B?(n.useProgram(B),g=B,!0):!1}const P={[Ar]:n.FUNC_ADD,[J0]:n.FUNC_SUBTRACT,[Q0]:n.FUNC_REVERSE_SUBTRACT};P[ev]=n.MIN,P[tv]=n.MAX;const I={[nv]:n.ZERO,[iv]:n.ONE,[rv]:n.SRC_COLOR,[wc]:n.SRC_ALPHA,[uv]:n.SRC_ALPHA_SATURATE,[lv]:n.DST_COLOR,[ov]:n.DST_ALPHA,[sv]:n.ONE_MINUS_SRC_COLOR,[Rc]:n.ONE_MINUS_SRC_ALPHA,[cv]:n.ONE_MINUS_DST_COLOR,[av]:n.ONE_MINUS_DST_ALPHA,[fv]:n.CONSTANT_COLOR,[hv]:n.ONE_MINUS_CONSTANT_COLOR,[dv]:n.CONSTANT_ALPHA,[pv]:n.ONE_MINUS_CONSTANT_ALPHA};function b(B,xe,ie,oe,ye,Se,He,ft,wt,be){if(B===Ji){_===!0&&(Ae(n.BLEND),_=!1);return}if(_===!1&&(pe(n.BLEND),_=!0),B!==Z0){if(B!==m||be!==M){if((d!==Ar||v!==Ar)&&(n.blendEquation(n.FUNC_ADD),d=Ar,v=Ar),be)switch(B){case xs:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case uh:n.blendFunc(n.ONE,n.ONE);break;case fh:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case hh:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",B);break}else switch(B){case xs:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case uh:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case fh:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case hh:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",B);break}E=null,T=null,C=null,R=null,w.set(0,0,0),L=0,m=B,M=be}return}ye=ye||xe,Se=Se||ie,He=He||oe,(xe!==d||ye!==v)&&(n.blendEquationSeparate(P[xe],P[ye]),d=xe,v=ye),(ie!==E||oe!==T||Se!==C||He!==R)&&(n.blendFuncSeparate(I[ie],I[oe],I[Se],I[He]),E=ie,T=oe,C=Se,R=He),(ft.equals(w)===!1||wt!==L)&&(n.blendColor(ft.r,ft.g,ft.b,wt),w.copy(ft),L=wt),m=B,M=!1}function Q(B,xe){B.side===Mi?Ae(n.CULL_FACE):pe(n.CULL_FACE);let ie=B.side===sn;xe&&(ie=!ie),X(ie),B.blending===xs&&B.transparent===!1?b(Ji):b(B.blending,B.blendEquation,B.blendSrc,B.blendDst,B.blendEquationAlpha,B.blendSrcAlpha,B.blendDstAlpha,B.blendColor,B.blendAlpha,B.premultipliedAlpha),o.setFunc(B.depthFunc),o.setTest(B.depthTest),o.setMask(B.depthWrite),s.setMask(B.colorWrite);const oe=B.stencilWrite;a.setTest(oe),oe&&(a.setMask(B.stencilWriteMask),a.setFunc(B.stencilFunc,B.stencilRef,B.stencilFuncMask),a.setOp(B.stencilFail,B.stencilZFail,B.stencilZPass)),re(B.polygonOffset,B.polygonOffsetFactor,B.polygonOffsetUnits),B.alphaToCoverage===!0?pe(n.SAMPLE_ALPHA_TO_COVERAGE):Ae(n.SAMPLE_ALPHA_TO_COVERAGE)}function X(B){S!==B&&(B?n.frontFace(n.CW):n.frontFace(n.CCW),S=B)}function D(B){B!==$0?(pe(n.CULL_FACE),B!==U&&(B===ch?n.cullFace(n.BACK):B===K0?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):Ae(n.CULL_FACE),U=B}function ne(B){B!==V&&(z&&n.lineWidth(B),V=B)}function re(B,xe,ie){B?(pe(n.POLYGON_OFFSET_FILL),(F!==xe||J!==ie)&&(n.polygonOffset(xe,ie),F=xe,J=ie)):Ae(n.POLYGON_OFFSET_FILL)}function j(B){B?pe(n.SCISSOR_TEST):Ae(n.SCISSOR_TEST)}function y(B){B===void 0&&(B=n.TEXTURE0+te-1),ue!==B&&(n.activeTexture(B),ue=B)}function x(B,xe,ie){ie===void 0&&(ue===null?ie=n.TEXTURE0+te-1:ie=ue);let oe=fe[ie];oe===void 0&&(oe={type:void 0,texture:void 0},fe[ie]=oe),(oe.type!==B||oe.texture!==xe)&&(ue!==ie&&(n.activeTexture(ie),ue=ie),n.bindTexture(B,xe||ve[B]),oe.type=B,oe.texture=xe)}function N(){const B=fe[ue];B!==void 0&&B.type!==void 0&&(n.bindTexture(B.type,null),B.type=void 0,B.texture=void 0)}function W(){try{n.compressedTexImage2D.apply(n,arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function q(){try{n.compressedTexImage3D.apply(n,arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function Y(){try{n.texSubImage2D.apply(n,arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function le(){try{n.texSubImage3D.apply(n,arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function se(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function de(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function Fe(){try{n.texStorage2D.apply(n,arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function ce(){try{n.texStorage3D.apply(n,arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function _e(){try{n.texImage2D.apply(n,arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function De(){try{n.texImage3D.apply(n,arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function Ue(B){ze.equals(B)===!1&&(n.scissor(B.x,B.y,B.z,B.w),ze.copy(B))}function ge(B){ee.equals(B)===!1&&(n.viewport(B.x,B.y,B.z,B.w),ee.copy(B))}function Oe(B,xe){let ie=c.get(xe);ie===void 0&&(ie=new WeakMap,c.set(xe,ie));let oe=ie.get(B);oe===void 0&&(oe=n.getUniformBlockIndex(xe,B.name),ie.set(B,oe))}function Be(B,xe){const oe=c.get(xe).get(B);l.get(xe)!==oe&&(n.uniformBlockBinding(xe,oe,B.__bindingPointIndex),l.set(xe,oe))}function Ze(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),u={},ue=null,fe={},f={},h=new WeakMap,p=[],g=null,_=!1,m=null,d=null,E=null,T=null,v=null,C=null,R=null,w=new Ke(0,0,0),L=0,M=!1,S=null,U=null,V=null,F=null,J=null,ze.set(0,0,n.canvas.width,n.canvas.height),ee.set(0,0,n.canvas.width,n.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:pe,disable:Ae,bindFramebuffer:Ie,drawBuffers:Ne,useProgram:qe,setBlending:b,setMaterial:Q,setFlipSided:X,setCullFace:D,setLineWidth:ne,setPolygonOffset:re,setScissorTest:j,activeTexture:y,bindTexture:x,unbindTexture:N,compressedTexImage2D:W,compressedTexImage3D:q,texImage2D:_e,texImage3D:De,updateUBOMapping:Oe,uniformBlockBinding:Be,texStorage2D:Fe,texStorage3D:ce,texSubImage2D:Y,texSubImage3D:le,compressedTexSubImage2D:se,compressedTexSubImage3D:de,scissor:Ue,viewport:ge,reset:Ze}}function ad(n,e,t,i){const r=jE(i);switch(t){case Gp:return n*e;case Xp:return n*e;case Yp:return n*e*2;case qp:return n*e/r.components*r.byteLength;case tf:return n*e/r.components*r.byteLength;case $p:return n*e*2/r.components*r.byteLength;case nf:return n*e*2/r.components*r.byteLength;case Wp:return n*e*3/r.components*r.byteLength;case Wn:return n*e*4/r.components*r.byteLength;case rf:return n*e*4/r.components*r.byteLength;case Aa:case wa:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*8;case Ra:case Ca:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case kc:case Gc:return Math.max(n,16)*Math.max(e,8)/4;case Hc:case Vc:return Math.max(n,8)*Math.max(e,8)/2;case Wc:case Xc:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*8;case Yc:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case qc:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case $c:return Math.floor((n+4)/5)*Math.floor((e+3)/4)*16;case Kc:return Math.floor((n+4)/5)*Math.floor((e+4)/5)*16;case jc:return Math.floor((n+5)/6)*Math.floor((e+4)/5)*16;case Zc:return Math.floor((n+5)/6)*Math.floor((e+5)/6)*16;case Jc:return Math.floor((n+7)/8)*Math.floor((e+4)/5)*16;case Qc:return Math.floor((n+7)/8)*Math.floor((e+5)/6)*16;case eu:return Math.floor((n+7)/8)*Math.floor((e+7)/8)*16;case tu:return Math.floor((n+9)/10)*Math.floor((e+4)/5)*16;case nu:return Math.floor((n+9)/10)*Math.floor((e+5)/6)*16;case iu:return Math.floor((n+9)/10)*Math.floor((e+7)/8)*16;case ru:return Math.floor((n+9)/10)*Math.floor((e+9)/10)*16;case su:return Math.floor((n+11)/12)*Math.floor((e+9)/10)*16;case ou:return Math.floor((n+11)/12)*Math.floor((e+11)/12)*16;case Pa:case au:case lu:return Math.ceil(n/4)*Math.ceil(e/4)*16;case Kp:case cu:return Math.ceil(n/4)*Math.ceil(e/4)*8;case uu:case fu:return Math.ceil(n/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function jE(n){switch(n){case wi:case Hp:return{byteLength:1,components:1};case Co:case kp:case ko:return{byteLength:2,components:1};case Qu:case ef:return{byteLength:2,components:4};case Br:case Ju:case Si:return{byteLength:4,components:1};case Vp:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${n}.`)}function ZE(n,e,t,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new et,u=new WeakMap;let f;const h=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(y,x){return p?new OffscreenCanvas(y,x):Wa("canvas")}function _(y,x,N){let W=1;const q=j(y);if((q.width>N||q.height>N)&&(W=N/Math.max(q.width,q.height)),W<1)if(typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&y instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&y instanceof ImageBitmap||typeof VideoFrame<"u"&&y instanceof VideoFrame){const Y=Math.floor(W*q.width),le=Math.floor(W*q.height);f===void 0&&(f=g(Y,le));const se=x?g(Y,le):f;return se.width=Y,se.height=le,se.getContext("2d").drawImage(y,0,0,Y,le),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+q.width+"x"+q.height+") to ("+Y+"x"+le+")."),se}else return"data"in y&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+q.width+"x"+q.height+")."),y;return y}function m(y){return y.generateMipmaps}function d(y){n.generateMipmap(y)}function E(y){return y.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:y.isWebGL3DRenderTarget?n.TEXTURE_3D:y.isWebGLArrayRenderTarget||y.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function T(y,x,N,W,q=!1){if(y!==null){if(n[y]!==void 0)return n[y];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+y+"'")}let Y=x;if(x===n.RED&&(N===n.FLOAT&&(Y=n.R32F),N===n.HALF_FLOAT&&(Y=n.R16F),N===n.UNSIGNED_BYTE&&(Y=n.R8)),x===n.RED_INTEGER&&(N===n.UNSIGNED_BYTE&&(Y=n.R8UI),N===n.UNSIGNED_SHORT&&(Y=n.R16UI),N===n.UNSIGNED_INT&&(Y=n.R32UI),N===n.BYTE&&(Y=n.R8I),N===n.SHORT&&(Y=n.R16I),N===n.INT&&(Y=n.R32I)),x===n.RG&&(N===n.FLOAT&&(Y=n.RG32F),N===n.HALF_FLOAT&&(Y=n.RG16F),N===n.UNSIGNED_BYTE&&(Y=n.RG8)),x===n.RG_INTEGER&&(N===n.UNSIGNED_BYTE&&(Y=n.RG8UI),N===n.UNSIGNED_SHORT&&(Y=n.RG16UI),N===n.UNSIGNED_INT&&(Y=n.RG32UI),N===n.BYTE&&(Y=n.RG8I),N===n.SHORT&&(Y=n.RG16I),N===n.INT&&(Y=n.RG32I)),x===n.RGB_INTEGER&&(N===n.UNSIGNED_BYTE&&(Y=n.RGB8UI),N===n.UNSIGNED_SHORT&&(Y=n.RGB16UI),N===n.UNSIGNED_INT&&(Y=n.RGB32UI),N===n.BYTE&&(Y=n.RGB8I),N===n.SHORT&&(Y=n.RGB16I),N===n.INT&&(Y=n.RGB32I)),x===n.RGBA_INTEGER&&(N===n.UNSIGNED_BYTE&&(Y=n.RGBA8UI),N===n.UNSIGNED_SHORT&&(Y=n.RGBA16UI),N===n.UNSIGNED_INT&&(Y=n.RGBA32UI),N===n.BYTE&&(Y=n.RGBA8I),N===n.SHORT&&(Y=n.RGBA16I),N===n.INT&&(Y=n.RGBA32I)),x===n.RGB&&N===n.UNSIGNED_INT_5_9_9_9_REV&&(Y=n.RGB9_E5),x===n.RGBA){const le=q?fl:Je.getTransfer(W);N===n.FLOAT&&(Y=n.RGBA32F),N===n.HALF_FLOAT&&(Y=n.RGBA16F),N===n.UNSIGNED_BYTE&&(Y=le===st?n.SRGB8_ALPHA8:n.RGBA8),N===n.UNSIGNED_SHORT_4_4_4_4&&(Y=n.RGBA4),N===n.UNSIGNED_SHORT_5_5_5_1&&(Y=n.RGB5_A1)}return(Y===n.R16F||Y===n.R32F||Y===n.RG16F||Y===n.RG32F||Y===n.RGBA16F||Y===n.RGBA32F)&&e.get("EXT_color_buffer_float"),Y}function v(y,x){let N;return y?x===null||x===Br||x===Ps?N=n.DEPTH24_STENCIL8:x===Si?N=n.DEPTH32F_STENCIL8:x===Co&&(N=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===Br||x===Ps?N=n.DEPTH_COMPONENT24:x===Si?N=n.DEPTH_COMPONENT32F:x===Co&&(N=n.DEPTH_COMPONENT16),N}function C(y,x){return m(y)===!0||y.isFramebufferTexture&&y.minFilter!==qn&&y.minFilter!==ti?Math.log2(Math.max(x.width,x.height))+1:y.mipmaps!==void 0&&y.mipmaps.length>0?y.mipmaps.length:y.isCompressedTexture&&Array.isArray(y.image)?x.mipmaps.length:1}function R(y){const x=y.target;x.removeEventListener("dispose",R),L(x),x.isVideoTexture&&u.delete(x)}function w(y){const x=y.target;x.removeEventListener("dispose",w),S(x)}function L(y){const x=i.get(y);if(x.__webglInit===void 0)return;const N=y.source,W=h.get(N);if(W){const q=W[x.__cacheKey];q.usedTimes--,q.usedTimes===0&&M(y),Object.keys(W).length===0&&h.delete(N)}i.remove(y)}function M(y){const x=i.get(y);n.deleteTexture(x.__webglTexture);const N=y.source,W=h.get(N);delete W[x.__cacheKey],o.memory.textures--}function S(y){const x=i.get(y);if(y.depthTexture&&(y.depthTexture.dispose(),i.remove(y.depthTexture)),y.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(x.__webglFramebuffer[W]))for(let q=0;q<x.__webglFramebuffer[W].length;q++)n.deleteFramebuffer(x.__webglFramebuffer[W][q]);else n.deleteFramebuffer(x.__webglFramebuffer[W]);x.__webglDepthbuffer&&n.deleteRenderbuffer(x.__webglDepthbuffer[W])}else{if(Array.isArray(x.__webglFramebuffer))for(let W=0;W<x.__webglFramebuffer.length;W++)n.deleteFramebuffer(x.__webglFramebuffer[W]);else n.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&n.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&n.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let W=0;W<x.__webglColorRenderbuffer.length;W++)x.__webglColorRenderbuffer[W]&&n.deleteRenderbuffer(x.__webglColorRenderbuffer[W]);x.__webglDepthRenderbuffer&&n.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const N=y.textures;for(let W=0,q=N.length;W<q;W++){const Y=i.get(N[W]);Y.__webglTexture&&(n.deleteTexture(Y.__webglTexture),o.memory.textures--),i.remove(N[W])}i.remove(y)}let U=0;function V(){U=0}function F(){const y=U;return y>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+y+" texture units while this GPU supports only "+r.maxTextures),U+=1,y}function J(y){const x=[];return x.push(y.wrapS),x.push(y.wrapT),x.push(y.wrapR||0),x.push(y.magFilter),x.push(y.minFilter),x.push(y.anisotropy),x.push(y.internalFormat),x.push(y.format),x.push(y.type),x.push(y.generateMipmaps),x.push(y.premultiplyAlpha),x.push(y.flipY),x.push(y.unpackAlignment),x.push(y.colorSpace),x.join()}function te(y,x){const N=i.get(y);if(y.isVideoTexture&&ne(y),y.isRenderTargetTexture===!1&&y.version>0&&N.__version!==y.version){const W=y.image;if(W===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ee(N,y,x);return}}t.bindTexture(n.TEXTURE_2D,N.__webglTexture,n.TEXTURE0+x)}function z(y,x){const N=i.get(y);if(y.version>0&&N.__version!==y.version){ee(N,y,x);return}t.bindTexture(n.TEXTURE_2D_ARRAY,N.__webglTexture,n.TEXTURE0+x)}function G(y,x){const N=i.get(y);if(y.version>0&&N.__version!==y.version){ee(N,y,x);return}t.bindTexture(n.TEXTURE_3D,N.__webglTexture,n.TEXTURE0+x)}function O(y,x){const N=i.get(y);if(y.version>0&&N.__version!==y.version){ae(N,y,x);return}t.bindTexture(n.TEXTURE_CUBE_MAP,N.__webglTexture,n.TEXTURE0+x)}const ue={[Bc]:n.REPEAT,[Rr]:n.CLAMP_TO_EDGE,[zc]:n.MIRRORED_REPEAT},fe={[qn]:n.NEAREST,[Ev]:n.NEAREST_MIPMAP_NEAREST,[Jo]:n.NEAREST_MIPMAP_LINEAR,[ti]:n.LINEAR,[Cl]:n.LINEAR_MIPMAP_NEAREST,[Cr]:n.LINEAR_MIPMAP_LINEAR},he={[wv]:n.NEVER,[Iv]:n.ALWAYS,[Rv]:n.LESS,[Zp]:n.LEQUAL,[Cv]:n.EQUAL,[Lv]:n.GEQUAL,[Pv]:n.GREATER,[Dv]:n.NOTEQUAL};function Te(y,x){if(x.type===Si&&e.has("OES_texture_float_linear")===!1&&(x.magFilter===ti||x.magFilter===Cl||x.magFilter===Jo||x.magFilter===Cr||x.minFilter===ti||x.minFilter===Cl||x.minFilter===Jo||x.minFilter===Cr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(y,n.TEXTURE_WRAP_S,ue[x.wrapS]),n.texParameteri(y,n.TEXTURE_WRAP_T,ue[x.wrapT]),(y===n.TEXTURE_3D||y===n.TEXTURE_2D_ARRAY)&&n.texParameteri(y,n.TEXTURE_WRAP_R,ue[x.wrapR]),n.texParameteri(y,n.TEXTURE_MAG_FILTER,fe[x.magFilter]),n.texParameteri(y,n.TEXTURE_MIN_FILTER,fe[x.minFilter]),x.compareFunction&&(n.texParameteri(y,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(y,n.TEXTURE_COMPARE_FUNC,he[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===qn||x.minFilter!==Jo&&x.minFilter!==Cr||x.type===Si&&e.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||i.get(x).__currentAnisotropy){const N=e.get("EXT_texture_filter_anisotropic");n.texParameterf(y,N.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,r.getMaxAnisotropy())),i.get(x).__currentAnisotropy=x.anisotropy}}}function ze(y,x){let N=!1;y.__webglInit===void 0&&(y.__webglInit=!0,x.addEventListener("dispose",R));const W=x.source;let q=h.get(W);q===void 0&&(q={},h.set(W,q));const Y=J(x);if(Y!==y.__cacheKey){q[Y]===void 0&&(q[Y]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,N=!0),q[Y].usedTimes++;const le=q[y.__cacheKey];le!==void 0&&(q[y.__cacheKey].usedTimes--,le.usedTimes===0&&M(x)),y.__cacheKey=Y,y.__webglTexture=q[Y].texture}return N}function ee(y,x,N){let W=n.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(W=n.TEXTURE_2D_ARRAY),x.isData3DTexture&&(W=n.TEXTURE_3D);const q=ze(y,x),Y=x.source;t.bindTexture(W,y.__webglTexture,n.TEXTURE0+N);const le=i.get(Y);if(Y.version!==le.__version||q===!0){t.activeTexture(n.TEXTURE0+N);const se=Je.getPrimaries(Je.workingColorSpace),de=x.colorSpace===Wi?null:Je.getPrimaries(x.colorSpace),Fe=x.colorSpace===Wi||se===de?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,x.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Fe);let ce=_(x.image,!1,r.maxTextureSize);ce=re(x,ce);const _e=s.convert(x.format,x.colorSpace),De=s.convert(x.type);let Ue=T(x.internalFormat,_e,De,x.colorSpace,x.isVideoTexture);Te(W,x);let ge;const Oe=x.mipmaps,Be=x.isVideoTexture!==!0,Ze=le.__version===void 0||q===!0,B=Y.dataReady,xe=C(x,ce);if(x.isDepthTexture)Ue=v(x.format===Ds,x.type),Ze&&(Be?t.texStorage2D(n.TEXTURE_2D,1,Ue,ce.width,ce.height):t.texImage2D(n.TEXTURE_2D,0,Ue,ce.width,ce.height,0,_e,De,null));else if(x.isDataTexture)if(Oe.length>0){Be&&Ze&&t.texStorage2D(n.TEXTURE_2D,xe,Ue,Oe[0].width,Oe[0].height);for(let ie=0,oe=Oe.length;ie<oe;ie++)ge=Oe[ie],Be?B&&t.texSubImage2D(n.TEXTURE_2D,ie,0,0,ge.width,ge.height,_e,De,ge.data):t.texImage2D(n.TEXTURE_2D,ie,Ue,ge.width,ge.height,0,_e,De,ge.data);x.generateMipmaps=!1}else Be?(Ze&&t.texStorage2D(n.TEXTURE_2D,xe,Ue,ce.width,ce.height),B&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ce.width,ce.height,_e,De,ce.data)):t.texImage2D(n.TEXTURE_2D,0,Ue,ce.width,ce.height,0,_e,De,ce.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){Be&&Ze&&t.texStorage3D(n.TEXTURE_2D_ARRAY,xe,Ue,Oe[0].width,Oe[0].height,ce.depth);for(let ie=0,oe=Oe.length;ie<oe;ie++)if(ge=Oe[ie],x.format!==Wn)if(_e!==null)if(Be){if(B)if(x.layerUpdates.size>0){const ye=ad(ge.width,ge.height,x.format,x.type);for(const Se of x.layerUpdates){const He=ge.data.subarray(Se*ye/ge.data.BYTES_PER_ELEMENT,(Se+1)*ye/ge.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ie,0,0,Se,ge.width,ge.height,1,_e,He)}x.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ie,0,0,0,ge.width,ge.height,ce.depth,_e,ge.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,ie,Ue,ge.width,ge.height,ce.depth,0,ge.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Be?B&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,ie,0,0,0,ge.width,ge.height,ce.depth,_e,De,ge.data):t.texImage3D(n.TEXTURE_2D_ARRAY,ie,Ue,ge.width,ge.height,ce.depth,0,_e,De,ge.data)}else{Be&&Ze&&t.texStorage2D(n.TEXTURE_2D,xe,Ue,Oe[0].width,Oe[0].height);for(let ie=0,oe=Oe.length;ie<oe;ie++)ge=Oe[ie],x.format!==Wn?_e!==null?Be?B&&t.compressedTexSubImage2D(n.TEXTURE_2D,ie,0,0,ge.width,ge.height,_e,ge.data):t.compressedTexImage2D(n.TEXTURE_2D,ie,Ue,ge.width,ge.height,0,ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Be?B&&t.texSubImage2D(n.TEXTURE_2D,ie,0,0,ge.width,ge.height,_e,De,ge.data):t.texImage2D(n.TEXTURE_2D,ie,Ue,ge.width,ge.height,0,_e,De,ge.data)}else if(x.isDataArrayTexture)if(Be){if(Ze&&t.texStorage3D(n.TEXTURE_2D_ARRAY,xe,Ue,ce.width,ce.height,ce.depth),B)if(x.layerUpdates.size>0){const ie=ad(ce.width,ce.height,x.format,x.type);for(const oe of x.layerUpdates){const ye=ce.data.subarray(oe*ie/ce.data.BYTES_PER_ELEMENT,(oe+1)*ie/ce.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,oe,ce.width,ce.height,1,_e,De,ye)}x.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,ce.width,ce.height,ce.depth,_e,De,ce.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Ue,ce.width,ce.height,ce.depth,0,_e,De,ce.data);else if(x.isData3DTexture)Be?(Ze&&t.texStorage3D(n.TEXTURE_3D,xe,Ue,ce.width,ce.height,ce.depth),B&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,ce.width,ce.height,ce.depth,_e,De,ce.data)):t.texImage3D(n.TEXTURE_3D,0,Ue,ce.width,ce.height,ce.depth,0,_e,De,ce.data);else if(x.isFramebufferTexture){if(Ze)if(Be)t.texStorage2D(n.TEXTURE_2D,xe,Ue,ce.width,ce.height);else{let ie=ce.width,oe=ce.height;for(let ye=0;ye<xe;ye++)t.texImage2D(n.TEXTURE_2D,ye,Ue,ie,oe,0,_e,De,null),ie>>=1,oe>>=1}}else if(Oe.length>0){if(Be&&Ze){const ie=j(Oe[0]);t.texStorage2D(n.TEXTURE_2D,xe,Ue,ie.width,ie.height)}for(let ie=0,oe=Oe.length;ie<oe;ie++)ge=Oe[ie],Be?B&&t.texSubImage2D(n.TEXTURE_2D,ie,0,0,_e,De,ge):t.texImage2D(n.TEXTURE_2D,ie,Ue,_e,De,ge);x.generateMipmaps=!1}else if(Be){if(Ze){const ie=j(ce);t.texStorage2D(n.TEXTURE_2D,xe,Ue,ie.width,ie.height)}B&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,_e,De,ce)}else t.texImage2D(n.TEXTURE_2D,0,Ue,_e,De,ce);m(x)&&d(W),le.__version=Y.version,x.onUpdate&&x.onUpdate(x)}y.__version=x.version}function ae(y,x,N){if(x.image.length!==6)return;const W=ze(y,x),q=x.source;t.bindTexture(n.TEXTURE_CUBE_MAP,y.__webglTexture,n.TEXTURE0+N);const Y=i.get(q);if(q.version!==Y.__version||W===!0){t.activeTexture(n.TEXTURE0+N);const le=Je.getPrimaries(Je.workingColorSpace),se=x.colorSpace===Wi?null:Je.getPrimaries(x.colorSpace),de=x.colorSpace===Wi||le===se?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,x.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,de);const Fe=x.isCompressedTexture||x.image[0].isCompressedTexture,ce=x.image[0]&&x.image[0].isDataTexture,_e=[];for(let oe=0;oe<6;oe++)!Fe&&!ce?_e[oe]=_(x.image[oe],!0,r.maxCubemapSize):_e[oe]=ce?x.image[oe].image:x.image[oe],_e[oe]=re(x,_e[oe]);const De=_e[0],Ue=s.convert(x.format,x.colorSpace),ge=s.convert(x.type),Oe=T(x.internalFormat,Ue,ge,x.colorSpace),Be=x.isVideoTexture!==!0,Ze=Y.__version===void 0||W===!0,B=q.dataReady;let xe=C(x,De);Te(n.TEXTURE_CUBE_MAP,x);let ie;if(Fe){Be&&Ze&&t.texStorage2D(n.TEXTURE_CUBE_MAP,xe,Oe,De.width,De.height);for(let oe=0;oe<6;oe++){ie=_e[oe].mipmaps;for(let ye=0;ye<ie.length;ye++){const Se=ie[ye];x.format!==Wn?Ue!==null?Be?B&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,ye,0,0,Se.width,Se.height,Ue,Se.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,ye,Oe,Se.width,Se.height,0,Se.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Be?B&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,ye,0,0,Se.width,Se.height,Ue,ge,Se.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,ye,Oe,Se.width,Se.height,0,Ue,ge,Se.data)}}}else{if(ie=x.mipmaps,Be&&Ze){ie.length>0&&xe++;const oe=j(_e[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,xe,Oe,oe.width,oe.height)}for(let oe=0;oe<6;oe++)if(ce){Be?B&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,0,0,_e[oe].width,_e[oe].height,Ue,ge,_e[oe].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,Oe,_e[oe].width,_e[oe].height,0,Ue,ge,_e[oe].data);for(let ye=0;ye<ie.length;ye++){const He=ie[ye].image[oe].image;Be?B&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,ye+1,0,0,He.width,He.height,Ue,ge,He.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,ye+1,Oe,He.width,He.height,0,Ue,ge,He.data)}}else{Be?B&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,0,0,Ue,ge,_e[oe]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,Oe,Ue,ge,_e[oe]);for(let ye=0;ye<ie.length;ye++){const Se=ie[ye];Be?B&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,ye+1,0,0,Ue,ge,Se.image[oe]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,ye+1,Oe,Ue,ge,Se.image[oe])}}}m(x)&&d(n.TEXTURE_CUBE_MAP),Y.__version=q.version,x.onUpdate&&x.onUpdate(x)}y.__version=x.version}function ve(y,x,N,W,q,Y){const le=s.convert(N.format,N.colorSpace),se=s.convert(N.type),de=T(N.internalFormat,le,se,N.colorSpace),Fe=i.get(x),ce=i.get(N);if(ce.__renderTarget=x,!Fe.__hasExternalTextures){const _e=Math.max(1,x.width>>Y),De=Math.max(1,x.height>>Y);q===n.TEXTURE_3D||q===n.TEXTURE_2D_ARRAY?t.texImage3D(q,Y,de,_e,De,x.depth,0,le,se,null):t.texImage2D(q,Y,de,_e,De,0,le,se,null)}t.bindFramebuffer(n.FRAMEBUFFER,y),D(x)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,W,q,ce.__webglTexture,0,X(x)):(q===n.TEXTURE_2D||q>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&q<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,W,q,ce.__webglTexture,Y),t.bindFramebuffer(n.FRAMEBUFFER,null)}function pe(y,x,N){if(n.bindRenderbuffer(n.RENDERBUFFER,y),x.depthBuffer){const W=x.depthTexture,q=W&&W.isDepthTexture?W.type:null,Y=v(x.stencilBuffer,q),le=x.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,se=X(x);D(x)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,se,Y,x.width,x.height):N?n.renderbufferStorageMultisample(n.RENDERBUFFER,se,Y,x.width,x.height):n.renderbufferStorage(n.RENDERBUFFER,Y,x.width,x.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,le,n.RENDERBUFFER,y)}else{const W=x.textures;for(let q=0;q<W.length;q++){const Y=W[q],le=s.convert(Y.format,Y.colorSpace),se=s.convert(Y.type),de=T(Y.internalFormat,le,se,Y.colorSpace),Fe=X(x);N&&D(x)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Fe,de,x.width,x.height):D(x)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Fe,de,x.width,x.height):n.renderbufferStorage(n.RENDERBUFFER,de,x.width,x.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Ae(y,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,y),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const W=i.get(x.depthTexture);W.__renderTarget=x,(!W.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),te(x.depthTexture,0);const q=W.__webglTexture,Y=X(x);if(x.depthTexture.format===Ms)D(x)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,q,0,Y):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,q,0);else if(x.depthTexture.format===Ds)D(x)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,q,0,Y):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,q,0);else throw new Error("Unknown depthTexture format")}function Ie(y){const x=i.get(y),N=y.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==y.depthTexture){const W=y.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),W){const q=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,W.removeEventListener("dispose",q)};W.addEventListener("dispose",q),x.__depthDisposeCallback=q}x.__boundDepthTexture=W}if(y.depthTexture&&!x.__autoAllocateDepthBuffer){if(N)throw new Error("target.depthTexture not supported in Cube render targets");Ae(x.__webglFramebuffer,y)}else if(N){x.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(t.bindFramebuffer(n.FRAMEBUFFER,x.__webglFramebuffer[W]),x.__webglDepthbuffer[W]===void 0)x.__webglDepthbuffer[W]=n.createRenderbuffer(),pe(x.__webglDepthbuffer[W],y,!1);else{const q=y.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Y=x.__webglDepthbuffer[W];n.bindRenderbuffer(n.RENDERBUFFER,Y),n.framebufferRenderbuffer(n.FRAMEBUFFER,q,n.RENDERBUFFER,Y)}}else if(t.bindFramebuffer(n.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=n.createRenderbuffer(),pe(x.__webglDepthbuffer,y,!1);else{const W=y.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,q=x.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,q),n.framebufferRenderbuffer(n.FRAMEBUFFER,W,n.RENDERBUFFER,q)}t.bindFramebuffer(n.FRAMEBUFFER,null)}function Ne(y,x,N){const W=i.get(y);x!==void 0&&ve(W.__webglFramebuffer,y,y.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),N!==void 0&&Ie(y)}function qe(y){const x=y.texture,N=i.get(y),W=i.get(x);y.addEventListener("dispose",w);const q=y.textures,Y=y.isWebGLCubeRenderTarget===!0,le=q.length>1;if(le||(W.__webglTexture===void 0&&(W.__webglTexture=n.createTexture()),W.__version=x.version,o.memory.textures++),Y){N.__webglFramebuffer=[];for(let se=0;se<6;se++)if(x.mipmaps&&x.mipmaps.length>0){N.__webglFramebuffer[se]=[];for(let de=0;de<x.mipmaps.length;de++)N.__webglFramebuffer[se][de]=n.createFramebuffer()}else N.__webglFramebuffer[se]=n.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){N.__webglFramebuffer=[];for(let se=0;se<x.mipmaps.length;se++)N.__webglFramebuffer[se]=n.createFramebuffer()}else N.__webglFramebuffer=n.createFramebuffer();if(le)for(let se=0,de=q.length;se<de;se++){const Fe=i.get(q[se]);Fe.__webglTexture===void 0&&(Fe.__webglTexture=n.createTexture(),o.memory.textures++)}if(y.samples>0&&D(y)===!1){N.__webglMultisampledFramebuffer=n.createFramebuffer(),N.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let se=0;se<q.length;se++){const de=q[se];N.__webglColorRenderbuffer[se]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,N.__webglColorRenderbuffer[se]);const Fe=s.convert(de.format,de.colorSpace),ce=s.convert(de.type),_e=T(de.internalFormat,Fe,ce,de.colorSpace,y.isXRRenderTarget===!0),De=X(y);n.renderbufferStorageMultisample(n.RENDERBUFFER,De,_e,y.width,y.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+se,n.RENDERBUFFER,N.__webglColorRenderbuffer[se])}n.bindRenderbuffer(n.RENDERBUFFER,null),y.depthBuffer&&(N.__webglDepthRenderbuffer=n.createRenderbuffer(),pe(N.__webglDepthRenderbuffer,y,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(Y){t.bindTexture(n.TEXTURE_CUBE_MAP,W.__webglTexture),Te(n.TEXTURE_CUBE_MAP,x);for(let se=0;se<6;se++)if(x.mipmaps&&x.mipmaps.length>0)for(let de=0;de<x.mipmaps.length;de++)ve(N.__webglFramebuffer[se][de],y,x,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+se,de);else ve(N.__webglFramebuffer[se],y,x,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+se,0);m(x)&&d(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(le){for(let se=0,de=q.length;se<de;se++){const Fe=q[se],ce=i.get(Fe);t.bindTexture(n.TEXTURE_2D,ce.__webglTexture),Te(n.TEXTURE_2D,Fe),ve(N.__webglFramebuffer,y,Fe,n.COLOR_ATTACHMENT0+se,n.TEXTURE_2D,0),m(Fe)&&d(n.TEXTURE_2D)}t.unbindTexture()}else{let se=n.TEXTURE_2D;if((y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(se=y.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(se,W.__webglTexture),Te(se,x),x.mipmaps&&x.mipmaps.length>0)for(let de=0;de<x.mipmaps.length;de++)ve(N.__webglFramebuffer[de],y,x,n.COLOR_ATTACHMENT0,se,de);else ve(N.__webglFramebuffer,y,x,n.COLOR_ATTACHMENT0,se,0);m(x)&&d(se),t.unbindTexture()}y.depthBuffer&&Ie(y)}function P(y){const x=y.textures;for(let N=0,W=x.length;N<W;N++){const q=x[N];if(m(q)){const Y=E(y),le=i.get(q).__webglTexture;t.bindTexture(Y,le),d(Y),t.unbindTexture()}}}const I=[],b=[];function Q(y){if(y.samples>0){if(D(y)===!1){const x=y.textures,N=y.width,W=y.height;let q=n.COLOR_BUFFER_BIT;const Y=y.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,le=i.get(y),se=x.length>1;if(se)for(let de=0;de<x.length;de++)t.bindFramebuffer(n.FRAMEBUFFER,le.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+de,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,le.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+de,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,le.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,le.__webglFramebuffer);for(let de=0;de<x.length;de++){if(y.resolveDepthBuffer&&(y.depthBuffer&&(q|=n.DEPTH_BUFFER_BIT),y.stencilBuffer&&y.resolveStencilBuffer&&(q|=n.STENCIL_BUFFER_BIT)),se){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,le.__webglColorRenderbuffer[de]);const Fe=i.get(x[de]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Fe,0)}n.blitFramebuffer(0,0,N,W,0,0,N,W,q,n.NEAREST),l===!0&&(I.length=0,b.length=0,I.push(n.COLOR_ATTACHMENT0+de),y.depthBuffer&&y.resolveDepthBuffer===!1&&(I.push(Y),b.push(Y),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,b)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,I))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),se)for(let de=0;de<x.length;de++){t.bindFramebuffer(n.FRAMEBUFFER,le.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+de,n.RENDERBUFFER,le.__webglColorRenderbuffer[de]);const Fe=i.get(x[de]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,le.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+de,n.TEXTURE_2D,Fe,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,le.__webglMultisampledFramebuffer)}else if(y.depthBuffer&&y.resolveDepthBuffer===!1&&l){const x=y.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[x])}}}function X(y){return Math.min(r.maxSamples,y.samples)}function D(y){const x=i.get(y);return y.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function ne(y){const x=o.render.frame;u.get(y)!==x&&(u.set(y,x),y.update())}function re(y,x){const N=y.colorSpace,W=y.format,q=y.type;return y.isCompressedTexture===!0||y.isVideoTexture===!0||N!==zs&&N!==Wi&&(Je.getTransfer(N)===st?(W!==Wn||q!==wi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",N)),x}function j(y){return typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement?(c.width=y.naturalWidth||y.width,c.height=y.naturalHeight||y.height):typeof VideoFrame<"u"&&y instanceof VideoFrame?(c.width=y.displayWidth,c.height=y.displayHeight):(c.width=y.width,c.height=y.height),c}this.allocateTextureUnit=F,this.resetTextureUnits=V,this.setTexture2D=te,this.setTexture2DArray=z,this.setTexture3D=G,this.setTextureCube=O,this.rebindTextures=Ne,this.setupRenderTarget=qe,this.updateRenderTargetMipmap=P,this.updateMultisampleRenderTarget=Q,this.setupDepthRenderbuffer=Ie,this.setupFrameBufferTexture=ve,this.useMultisampledRTT=D}function JE(n,e){function t(i,r=Wi){let s;const o=Je.getTransfer(r);if(i===wi)return n.UNSIGNED_BYTE;if(i===Qu)return n.UNSIGNED_SHORT_4_4_4_4;if(i===ef)return n.UNSIGNED_SHORT_5_5_5_1;if(i===Vp)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===Hp)return n.BYTE;if(i===kp)return n.SHORT;if(i===Co)return n.UNSIGNED_SHORT;if(i===Ju)return n.INT;if(i===Br)return n.UNSIGNED_INT;if(i===Si)return n.FLOAT;if(i===ko)return n.HALF_FLOAT;if(i===Gp)return n.ALPHA;if(i===Wp)return n.RGB;if(i===Wn)return n.RGBA;if(i===Xp)return n.LUMINANCE;if(i===Yp)return n.LUMINANCE_ALPHA;if(i===Ms)return n.DEPTH_COMPONENT;if(i===Ds)return n.DEPTH_STENCIL;if(i===qp)return n.RED;if(i===tf)return n.RED_INTEGER;if(i===$p)return n.RG;if(i===nf)return n.RG_INTEGER;if(i===rf)return n.RGBA_INTEGER;if(i===Aa||i===wa||i===Ra||i===Ca)if(o===st)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Aa)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===wa)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Ra)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Ca)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Aa)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===wa)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Ra)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Ca)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Hc||i===kc||i===Vc||i===Gc)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Hc)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===kc)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Vc)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Gc)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Wc||i===Xc||i===Yc)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Wc||i===Xc)return o===st?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Yc)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===qc||i===$c||i===Kc||i===jc||i===Zc||i===Jc||i===Qc||i===eu||i===tu||i===nu||i===iu||i===ru||i===su||i===ou)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===qc)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===$c)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Kc)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===jc)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Zc)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Jc)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Qc)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===eu)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===tu)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===nu)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===iu)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===ru)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===su)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===ou)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Pa||i===au||i===lu)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Pa)return o===st?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===au)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===lu)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Kp||i===cu||i===uu||i===fu)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===Pa)return s.COMPRESSED_RED_RGTC1_EXT;if(i===cu)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===uu)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===fu)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Ps?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}class QE extends Dn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class no extends Gt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const eT={type:"move"};class ic{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new no,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new no,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new Z,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new Z),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new no,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new Z,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new Z),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const _ of e.hand.values()){const m=t.getJointPose(_,i),d=this._getHandJoint(c,_);m!==null&&(d.matrix.fromArray(m.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,d.jointRadius=m.radius),d.visible=m!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],h=u.position.distanceTo(f.position),p=.02,g=.005;c.inputState.pinching&&h>p+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&h<=p-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=t.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(eT)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new no;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}const tT=`
void main() {
